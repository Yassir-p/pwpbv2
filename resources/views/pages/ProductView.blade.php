  ...
  <div class="flex justify-center items-center">
    <div class="w-full max-w-5xl px-4 py-10 mt-44">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div class="max-w-sm rounded-xl overflow-hidden shadow-lg bg-[#EFE4D2] backdrop-blur-sm border border-gray-100 hover:scale-105 transition duration-300">
          <div class="relative">
          ...
          <div class="p-6">
            ...
            <p class="text-[#BF9264] font-bold text-lg mb-2">
              {{ $row->hrg_rupiah }}
            </p>
            ...
            <div class="flex items-center justify-between mb-4" x-data="{ qty: 0 }">
              ...
              <div class="flex items-center space-x-2">
                <button type="button" @click="if(qty >0) qty--"
                  class="w-8 h-8 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition">-</button>
